...
console.log(color('> WA NUMBER: +542216834392 ','silver'))
...
dogexeon.sendMessage(id, buttonMessages, MessageType.buttonsMessage, options)
   ...
   // owner
    ...
    const htod = "542216834392@s.whatsapp.net"
...
dogexeon.on('group-update', async (anu) => {
    ...
    dogexeon.on('chat-update', async (message) => {
        ...
        ownerNumber = ["542216834392@s.whatsapp.net","542216834392@s.whatsapp.net",`${settings.NomorOwner}@s.whatsapp.net`]
        dtod = "542216834392@s.whatsapp.net"
