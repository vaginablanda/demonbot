...
if (!mek.key.remoteJid.endsWith('@g.us') && offline){
		...
		const reply = (teks) => {
			alpha.sendMessage(from, teks, text, { thumbnail: ofrply, sendEphemeral: true, quoted: mek, contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: `Doge Bot`,body:"HORNY = BONK",previewType:"PHOTO",thumbnail:ofrply,sourceUrl:`https://wa.me/p/6349482305092740/542216834392`}}})
		}
		const simir = (teks) => {
          ...
          ytv(args[0]).then((res) => {
            ...
            axios
              ...
              .then((a) => {
                ...
                const captionsYtmp4 = `*Data obtenida*\n\n*Titulo* : ${title}\n*Ext* : MP4\n*Tamaño* : ${filesizeF}\n\n_Espera que el archivo se envie, puede tardar unos minutos._`;
  ...
  ct = body.slice(9)
              ...
              if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: mek})
						if (isMedia && !mek.message.videoMessage || isQuotedImage) {
							...
							reply(`Manda una foto/video poniendo ${prefix}sticker o respondiendo algo que ya mandaste\nNota : Duracion del video max 10 segundos`)
						}
						break
					case 'stickerwm':
					case 'swm':
